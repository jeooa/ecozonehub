  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-1">
        <a href="<?= baseurl() ?>/administrator/pos"
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
          <img src="/ecozonehub/public/dist/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow"
            alt="User Image" />
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          ...
          <li class="user-header text-bg-primary">
            <img src="/ecozonehub/public/dist/assets/img/user2-160x160.jpg" class="rounded-circle shadow"
              alt="User Image" />
            <p>
