...
<style>
    ...
    body::before {
        ...
        width: 100%;
        height: 45vh;
        background: #fafafa url('<?= baseurl(); ?>/dist/assets/img/collage.png') center/cover no-repeat;
...
<div class="login-container mt-5">
    <div class="login-section">
        <div class="logo-container">
            <img src="<?= baseurl(); ?>/dist/assets/img/eco-zone-logo.png" alt="Eco-Zone Logo" class="logo-image">
        </div>
